    ...
    methods: {
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                ...
                this.report_new.citizenid = null;
...
function reload(){
    var container = document.getElementById("page == 'Search Vehicles'");
